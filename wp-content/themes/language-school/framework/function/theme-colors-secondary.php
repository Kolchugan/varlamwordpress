...
/***************** Start {$title} LearnPress Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_course_sidebar .course-wishlist,
	...
	{$rule}.learn-press-tabs li.current a,
	{$rule}.learn-press-tabs li a:hover,
	{$rule}.quiz-result-mark,
	{$rule}.quiz-result .quiz-result-summary .quiz-result-field > label,
	{$rule}#quiz-countdown,
	{$rule}.curriculum-sections .section-content > li.course-quiz .quiz-icon:before, 
	{$rule}.curriculum-sections .section-content > li.course-lesson .lesson-icon:before,
	...
	{$rule}.lp-course-progress .lp-progress-value,
	{$rule}.lp-label-viewing,
	{$rule}.lp-label-final,
	{$rule}#user_quizzes .quiz-result-mark:before,
	{$rule}.learn-press-tabs li:before,
	{$rule}.learn-press .message:before,
	...
	{$rule}.lp-course-progress .lp-passing-conditional span,
	{$rule}.learn-press-tabs li.current a,
	...
	{$rule}.lp-course-progress .lp-passing-conditional span:after,
	{$rule}.learn-press-tabs li.current a {
	...
	{$rule}.lp-course-progress .lp-passing-conditional span:before {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_border']) . "
	}
	
	{$rule}.lp-course-progress .lp-progress-value > span:before {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option[CMSMASTERS_SHORTNAME . '_' . $scheme . '_border']) . "
	}
